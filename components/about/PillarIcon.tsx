...
// أصلي بسيط يعكس المعنى (خريطة/قلب، أيدي، سلة، هاتف آمن)، لا يُقلّد أي
// عمل بصري أو أيقونة محمية بعينها.
...
const PATHS: Record<Pillar, React.ReactNode> = {
  saudi: (
    <>
      ...
      <path d="M12 5.5v13" fill="none" stroke="currentColor" strokeWidth={0} />
      <path d="M12 8.5c.9-.7 1.6-.4 1.6.7s-.9 1.7-1.6 1.1c-.7.6-1.6.2-1.6-1s.7-1.4 1.6-.8Z" fill="currentColor" stroke="none" />
    </>
  ),
  community: (
...
export default function PillarIcon({ pillar, size = 26 }: { pillar: Pillar; size?: number }) {
  return (
